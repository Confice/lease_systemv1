    ...
    <div style="width: 100%; padding: 40px 0; background-color: #f4f6f8; text-align: center;">
        <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; padding: 40px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); text-align: left;">
            ...
            <p style="color: #555555; font-size: 16px; line-height: 1.5;">
                We’re excited to welcome you to <strong style="color:#333333;">LEASE (LeaseEase X StoreEdge)</strong> – the official property management platform of <strong style="color:#333333;">D & G Properties</strong>.
            </p>
            <p style="color: #555555; font-size: 16px; line-height: 1.5;">
                Your account has been created, and you’re just one step away from getting started. Please set your password using the link below:
            </p>

            <p>
                <a href="{{ route('setup.password', ['token' => $token]) }}" target="_blank" 
            ...
            <p style="color: #ff4d4f; font-size: 14px; line-height: 1.5;">
                ⚠️ Please note: This password setup link will expire in <strong>60 minutes</strong>.
            </p>

            <p style="color: #555555; font-size: 16px; line-height: 1.5;">
                This will activate your account and give you full access to your dashboard.
            </p>
            <p style="color: #555555; font-size: 16px; line-height: 1.5;">
