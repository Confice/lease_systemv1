      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            <!-- Dashboard -->
            <li class="menu-item {{ request()->is('tenants/dashboard') || request()->is('dashboard') ? 'active' : '' }}">
              <a href="{{ route('tenants.dashboard') }}" class="menu-link" title="Dashboard">
            ...
            <li class="menu-item {{ request()->is('marketplace*') ? 'active' : '' }}">
              <a href="{{ route('tenants.marketplace.index') }}" class="menu-link" title="Marketplace Map">
            ...
            <!-- My Stalls -->
            <li class="menu-item {{ request()->is('tenants/stalls*') ? 'active' : '' }}">
              <a href="{{ route('tenants.stalls.index') }}" class="menu-link" title="My Stalls">
                <i class="menu-icon tf-icons bx bx-store"></i>
                <div data-i18n="Stalls">My Stalls</div>
              </a>
            </li>

            <!-- My Bills -->
            <li class="menu-item {{ request()->is('bills*') ? 'active' : '' }}">
              <a href="{{ route('tenants.bills.index') }}" class="menu-link" title="My Bills">
                <i class="menu-icon tf-icons bx bx-credit-card"></i>
                <div data-i18n="Bills">My Bills</div>
              </a>
            </li>

            <!-- My Leases -->
            <li class="menu-item {{ request()->is('leases*') ? 'active' : '' }}">
              <a href="{{ route('tenants.leases.index') }}" class="menu-link" title="My Leases">
                <i class="menu-icon tf-icons bx bx-file"></i>
                <div data-i18n="Leases">My Leases</div>
              </a>
            </li>

            <!-- Feedback -->
            <li class="menu-item {{ request()->is('tenants/feedback') ? 'active' : '' }}">
              <a href="{{ route('tenants.feedback.index') }}" class="menu-link" title="Feedback">
            ...
            <li class="menu-item {{ request()->is('contact-us') ? 'active' : '' }}">
              <a href="{{ route('tenants.contact.index') }}" class="menu-link" title="Contact Us">
